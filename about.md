...
|1|튜토리얼5|현청천![사진](./pic/hun.png)|헬로엔엠에스|Transformer & BERT 구현하기|Transformer는 가장 기본이 되는 모델입니다. NLP를 하시는 분이라면 꼭 봐야하고 깊게 이해할 필요가 있다고 생각됩니다. BERT는 Transformer Encoder를 사용한 모델입니다. BERT는 현재 NLP의 표준모델이라고 봐도 무방합니다. BERT는 발표 된지 1년이 지난 현재 까지도 다양한 시도를 통해 개선되고 발전되고 있는 모델입니다. 이 두 모델을 가장 작은 형태로 구현해 보는 과정을 통해 더 깊이 이해하는 것이 목표입니다.(고급)|        
